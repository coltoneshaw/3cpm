...
export type AccountCurrencyRates3CAPI = {
  last: string
  bid: string,
  ask: string,
...
export type AccountsMarketList3CAPI = {
  market_name: string,
  market_url: URL,
  market_icon: URL,
  help_link: URL,
...
export type AccountTableData3CAPI = {
...
export type AccountPieChartData3CAPI = {
  code: string,
