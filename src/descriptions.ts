...
const descriptions = {
    calculations: {
        ...
        risk: (maxDCA:number, totalBankroll:number) => ` is calculated by dividing your total DCA max risk of ${parseNumber(maxDCA)} by your current bankroll of ${parseNumber(totalBankroll)}.`,
