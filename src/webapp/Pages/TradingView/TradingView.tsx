...
const TradingViewPage = () => {
  ...
  const assignScript = (cTheme: string) => {
    ...
    <>
      ...
      <div className="tradingview-widget-container" id="tvcontainer" style={{ height: '80vh' }} ref={tvContainer}>
        <div className="tradingview-widget-container">
          <div id="tradingview_a6bc1" style={{ height: '80vh' }} />
          <div className="tradingview-widget-copyright">
            <a href="https://www.tradingview.com/symbols/" rel="noopener noreferrer" target="_blank">
