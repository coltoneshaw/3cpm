...
**Endpoint:**  
 `GET /public/api/ver1/accounts/{account_id}/balance_chart_data`
...
[
  {
    ...
    api_key: '', // key when connecting to your exchange
...
**Endpoint**: `GET /ver1/deals/`  
[Official Docs](https://github.com/3commas-io/3commas-official-api-docs/blob/master/deals_api.md#user-deals-permission-bots_read-security-signed)
...
**Notes:** This endpoint only returns orders for bot deals themselves.
...
[
    {
        ...
        "quantity": "2490.0",
        "quantity_remaining": "0.0", // orders can be only partially filled.
        "total": "3376.4804625", // This will be a 0 on a sell order
        "rate": "1.357",
        "average_price": "1.355" // This will be a 0 on a sell order
    },
    {
